...
const Header = () => {
  ...
  return (
    <Fragment>
      <div style={{backgroundColor:'#f7f8f9', boxShadow: 'none'}}  className={`page-header  ${toggleIcon ? 'close_icon' : ''}`} >
        <Row style={{ paddingBlock:'0px',backgroundColor:'#F7F8F9', boxShadow: 'none'}}  className='header-wrapper  m-0 '>
